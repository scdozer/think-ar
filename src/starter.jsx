...
import targetFile2 from './assets/flower.zpt';
...
function Cubes() {
 ...
 color
  ...
  return (
    ...
    <instancedMesh receiveShadow castShadow ref={ref} args={[null , null , n]}>
    ...
    return (
      <Suspense fallback={<Html>Loading...</Html>}>
        <ZapparCanvas shadowMap>
          ...
          <ImageTracker
            onNotVisible={() => setVisibleState2(false)}
            onNewAnchor={(anchor) => console.log(`New anchor ${anchor.id}`)}
            onVisible={() => setVisibleState2(true)}
            targetImage={targetFile2}
